    ...
    <div class="app-content content">
        <div class="content-wrapper">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">كل المستويات</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                    ...
                    <div id="recent-transactions" class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">المستويات ({{$levels->total()}})</h4>
                            ...
                            <div class="card-content">
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover table-xl mb-0 sortable">
                                        <thead>
                                        <tr>
                                            <th class="border-top-0">  اسم المستوي</th>
                                        ...
                                        @forelse($levels as $level )
                                            ...
                                            <tr class="row1" data-id="{{ $level->id }}" >
                                                <td>{{$level->name}}</td>

                                                <td>
                                                    @foreach($level->sports as $sports)

                                                        @foreach($sports->branches as  $branch)
                                                    ...
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <form action="{{route('level.destroy' ,$level->id)}}" method="POST" class="btn-group">
                                                            ...
                                                            <button
                                                                ...
                                                                onclick="return confirm('حذف هذا اللعبه سيقوم بحذف جميع الفروع و الالعاب المتعلقه به!! هل انت متاكد من الحذف ؟')"
                                                            >
                                                                حذف
                                                            </button>
                                                        </form>
                ...
                @if($levels->hasPages())
                    {{$levels->appends(request()->input())->links('pagination::bootstrap-4')}}
                @endif
                <!--/ Recent Transactions -->
            </div>
        </div>
